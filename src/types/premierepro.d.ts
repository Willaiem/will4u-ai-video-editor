declare module "premierepro" {
  ...
  export type AddTransitionOptions = {
  ...
  export type AppPreferenceStatic = {
  ...
  export type AudioClipTrackItemStatic = {
  ...
  export type AudioClipTrackItem = {
  ...
  export type AudioComponentChainStatic = {};

  export type AudioComponentChain = {
  ...
  export type CaptionTrackStatic = {};
  ...
  export type ClipProjectItemStatic = {
    cast(projectItem: ProjectItem): any;
  };

  type ColorSpace = {};

  export type ClipProjectItem = {
  ...
  export type ComponentParam = {
    ...
    findNearestKeyframe(TickTime1: object, TickTime2: object): Keyframe; //Find sthe nearest key for the given time
  ...
  export type EncoderManagerStatic = {
  ...
  export type FootageInterpretation = {
  ...
  export type ProjectStatic = {
    ...
    ): Promise<Project>; //Open a project
  ...
  export type ProjectClosedEventStatic = {
  ...
  export type ProjectEventStatic = {
  ...
  export type ScratchDiskSettingsStatic = {
  ...
  export type ScratchDiskSettings = {
    setScratchDiskPath(
  ...
  export type SequenceUtilsStatic = {
  ...
  export type SequenceUtils = {};

  export type SourceMonitorStatic = {
  ...
  export type TransitionFactoryStatic = {
  ...
  export type UtilsStatic = {
    isAEInstalled(): Promise<boolean>; //Check if AE is installed.
  };

  export type Utils = {};

  export type VideoClipTrackItemStatic = {
    TRACKITEMTYPE_EMPTY: number; //Empty Track Item Type
    TRACKITEMTYPE_CLIP: number; //Clip Track Item Type
    TRACKITEMTYPE_TRANSITION: number; //Transition Track Item Type
    TRACKITEMTYPE_PREVIEW: number; //Previe Track Item Type
  ...
  export type VideoClipTrackItem = {
  ...
  export type VideoComponentChainStatic = {};

  export type VideoComponentChain = {
    createInsertComponentAction(
      component: object,
      componentInsertionIndex: number
    ): Action; //Creates and returns an insert component action
  ...
  export type VideoFilterComponentStatic = {};

  export type VideoFilterComponent = {};

  export type VideoFilterFactoryStatic = {
  ...
  export type VideoFilterFactory = {};

  export type VideoTrackStatic = {
    EVENT_TRACK_CHANGED: string; //Event Object for Track changed
    EVENT_TRACK_INFO_CHANGED: string; //Event Object for Track Info Changed
    EVENT_TRACK_LOCK_CHANGED: string; //Event Object for Track Lock Changed
  };
  ...
  export type VideoTransitionStatic = {
